...
#file_handle = open(f"customers/root/uploadedfiles/unprotected/unprotected/branding/home.jpg", "rb")
#print(aws.upload_binary_obj(f"demo/uploadedfiles/unprotected/branding/home.jpg", file_handle.read()))

print(aws.upload_file(f"../customers/root/uploadedfiles/unprotected/branding/home.jpg",
                      f"root/uploadedfiles/unprotected/branding/home.jpg"))
